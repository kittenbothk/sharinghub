...
{% file src="../../../.gitbook/assets/智能停車場.pdf" %}

## 範例生成指令詞

```
做一個智能停車場程式，利用P2超聲波檢測車輛駛入，當車輛駛入時控制P1舵機升起閘門，將閘門角度改為0度和90度
假設停車場有3個車位，每次有車輛駛入就佔用一個空位 使用按鍵模擬車輛離開放出停車位
```
...
{% file src="../../../.gitbook/assets/parking_lot.py" %}

## 示範短片

{% embed url="https://youtu.be/W9lps_XMnJg?si=pXp0Cx1yBnK-K3vx&t=79" %}
