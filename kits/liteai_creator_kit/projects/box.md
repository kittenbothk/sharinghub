...
{% file src="../../../.gitbook/assets/智能儲物箱.pdf" %}

## 範例生成指令詞

```
寫一個智能箱子的程式，利用P1超聲波檢測手，當揮手時P2的舵機由135打開至-45度，用P3的灰度感應器檢測箱子是否已放物品，將箱子空或滿的情況顯示出來
```

在對話中加入以下模塊：超聲波感應器，灰度感應器，舵機
...
{% file src="../../../.gitbook/assets/smart_box.py" %}

## 示範短片

{% embed url="https://drive.google.com/file/d/14dUIFEMXGsSNkoX2RQxDxBO6CvZUNjq1/view?usp=drive_link" %}
