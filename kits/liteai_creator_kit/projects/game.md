...
{% file src="../../../.gitbook/assets/遊戲手掣.pdf" %}

## 範例生成指令詞

```
寫一個華容道遊戲的程式，在3x3的棋盤上隨機分佈1-8數字 玩家透過AB按鍵選擇要移動的數字，使用五向搖桿模組移動數字
```
...
{% file src="../../../.gitbook/assets/huarongdao.py" %}

## 示範短片

{% embed url="https://drive.google.com/file/d/1DMRfp9OOUsfToXrw38MeOpz3aMry7XW0/view?usp=drive_link" %}
