...
{% file src="../../../.gitbook/assets/未來廣告牌.pdf" %}

## 範例生成指令詞

```
寫一個廣告牌程式，當P1人體紅外線感應到人走動時，亮起P2 Sugar LED燈，並在屏幕上以滾動形式顯示一段介紹快餐店新產品的廣告
```

在對話中加入以下模塊：LED模組，PIR模組
...
{% file src="../../../.gitbook/assets/advertising_board.py" %}

## 示範短片

{% embed url="https://youtu.be/W9lps_XMnJg?si=T9K3hyZR0X0v5L54&t=198" %}
