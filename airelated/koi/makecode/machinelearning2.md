...
### 插入MicroSD卡[¶](/broken/pages/93djBXpeag6DiuVNAnbk)
...
### 編寫模型訓練程式[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

<figure><img src="https://kittenbothk.readthedocs.io/en/latest/_images/mcbanner.png" alt=""><figcaption></figcaption></figure>

#### 加載KOI插件：[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

#### 在擴展頁直接搜尋KOI (KOI已經過微軟認證，可以直接搜尋)[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

<figure><img src="https://kittenbothk.readthedocs.io/en/latest/_images/koi_search.png" alt=""><figcaption></figcaption></figure>

#### 你亦可以用插件地址搜尋[¶](/broken/pages/93djBXpeag6DiuVNAnbk)
...
### 程式流程[¶](/broken/pages/93djBXpeag6DiuVNAnbk)
...
### 參考短片[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

{% embed url="https://www.youtube.com/watch?feature=youtu.b&v=UsjingLwnHc" %}

### 插件版本與更新[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

插件可能會不定時推出更新，改進功能。亦有時候我們可能需要轉用舊版插件才可使用某些功能。

詳情請參考: [Makecode插件版本更換](../../../programmingplatforms/makecode/makecodeextupdate.md)

### FAQ[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

#### 1： 為什麼我重新開機，按下按鍵，但按鍵沒有反應？[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

· 答：打開電源後, KOI 及microbit 同時起動; 相對上, Microbit 所需的起動時間比KOI魔塊短, 引致 Microbit的初始化程式已經跑完了，KOI還沒完全起動, 因此按鍵沒有反應。

· 解決辦法：打開電源後，重新按下Microbit背後的Reset按鍵，讓Microbit重新開始運行（秘訣就是讓KOI魔塊先完全運行起來，再讓Microbit 跑初始化程式）

#### 2： KOI鯉魚魔塊我直接3V電源可以嗎？[¶](/broken/pages/93djBXpeag6DiuVNAnbk)

· 答：不行，必須要接5V！

#### 3: 為什麼我在KOI固件版本v1.8.2上嘗試訓練分類器時，螢幕出現紅字警告，不能成功訓練分類器？[¶](/broken/pages/93djBXpeag6DiuVNAnbk)
